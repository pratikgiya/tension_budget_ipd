# Chords - Python (TensionBudget Edition)

> [!IMPORTANT]
> **🌟 WORKING ON TENSIONBUDGET ERGONOMIC SURVEILLANCE OR MACHINE LEARNING PIPELINES?**  
> Please consult the official collaborator documentation here: **[👉 TensionBudget Collaborator Onboarding & Setup Guide](TENSIONBUDGET_ONBOARDING_GUIDE.md)**.  
> It contains step-by-step installation instructions, commands for running simulated offline replay experiments, connecting dual-Arduino LSL hardware streams, performing initial shrug calibrations, and exporting wide-format feature datasets!
